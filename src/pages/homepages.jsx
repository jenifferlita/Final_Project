    ...
    <div>
        <nav className="navbar navbar-default navbar-fixed-top" role="navigation">
            ...
            <div className="row">
                ...
                <a className="navbar-brand" href="#">Universitas Klabat</a>
                </div>
        ...
        <section className="social_connect">
            ...
            <div className="col-md-6">
                ...
                <li><a className="icon-twitter color_animation" href="#" target="_blank" /></li>
                <li><a className="icon-github color_animation" href="#" target="_blank" /></li>
                <li><a className="icon-linkedin color_animation" href="#" target="_blank" /></li>
                <li><a className="icon-mail color_animation" href="#" /></li>
                </ul>
            </div>
            ...
            <div className="row">
                ...
                <div className="inner contact">
                    ...
                    <form id="contact-us" method="post" action="contact.php">
                        ...
                        <div className="col-md-6">
                        {/* Message */}
                        <textarea name="message" id="message" className="form textarea" placeholder="Message" defaultValue={""} />
        ...
        <footer className="sub_footer">
            <div className="container">
            <div className="col-md-4"><p className="sub-footer-text text-center">© Restaurant 2014, Theme by <a href="https://themewagon.com/">ThemeWagon</a></p></div>
